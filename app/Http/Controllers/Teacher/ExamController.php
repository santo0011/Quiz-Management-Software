...
class ExamController extends Controller
{
    ...
    public function updateCategory(ExamCategoryRequest $request, Exam $exam): RedirectResponse
    {
        ...
        return redirect()->route('teacher.questions.create', $exam)->with('success', 'Question category saved successfully.');
    }
    ...
    public function reorderItems(Request $request, Exam $exam): RedirectResponse
    {
        ...
        return redirect()->route('teacher.exams.show', $exam)->with('success', 'Order updated successfully.');
    }
    ...
    public function publish(Request $request, Exam $exam): RedirectResponse|\Illuminate\Http\JsonResponse
    {
        ...
        return redirect()->route('teacher.exams.index')->with('success', 'Exam published successfully.');
    }
    ...
    public function unpublish(Request $request, Exam $exam): RedirectResponse|\Illuminate\Http\JsonResponse
    {
        ...
        return redirect()->route('teacher.exams.show', $exam)->with('success', 'Exam unpublished successfully.');
    }

    /**
     * Management actions (edit, delete, publish, reorder) are restricted to
     * the teacher's own branch's exams — global (Super Admin) exams are
     * managed only from the Super Admin panel.
     */

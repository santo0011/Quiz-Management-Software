...
class QuestionController extends Controller
{
    ...
    public function store(MultiQuestionRequest $request, Exam $exam): RedirectResponse
    {
        ...
        return redirect()->route('teacher.questions.create', $exam)->with('success', $message);
    }
    ...
    public function createForPassage(Request $request, Exam $exam, PassageGroup $passageGroup): View
    {
        ...
        return view('teacher.passage-groups.questions-create', [
            'branch' => $request->user()->branch,
    ...
    public function update(QuestionRequest $request, Question $question): RedirectResponse
    {
        ...
        return redirect()->route('teacher.questions.create', $exam)->with('success', 'Question updated successfully.');
    }
    ...
    public function destroy(Request $request, Question $question): RedirectResponse
    {
        ...
        return redirect()->route('teacher.questions.create', $exam)->with('success', 'Question deleted successfully.');
    }

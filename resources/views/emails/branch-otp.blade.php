...
@section('content')
    <h2 class="greeting" style="margin:0 0 12px; font-size:18px; font-weight:600; color:#1e293b;">Hello {{ $branch->name }},</h2>

    <div class="message" style="color:#475569; margin-bottom:20px;">
        <p style="margin:0 0 10px;">We received a request to reset the password for your <strong>QuizCore</strong> Branch account.</p>

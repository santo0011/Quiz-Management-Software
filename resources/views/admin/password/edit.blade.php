    ...
    <section class="content-panel narrow-panel">
        <div class="panel-header">
            <div>
                ...
                <p>Replace your current password with a new secure one.</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.password.update') }}" class="admin-form">
            ...
            <div class="mb-4">
                ...
                <div class="password-field">
                    <input id="password_confirmation" type="password" name="password_confirmation" class="form-control @error('password') is-invalid @enderror" required>
                    <button class="password-toggle" type="button" aria-label="Show password" data-password-toggle>
                        <i class="bi bi-eye-fill"></i>
                    </button>
                </div>

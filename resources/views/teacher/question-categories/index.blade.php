...
@section('content')
    <section class="content-panel mb-4">
        ...
        <form method="GET" action="{{ route('teacher.question-categories.index') }}" class="filter-bar compact-filter-bar mb-0">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="action-group">
                                        ...
                                        <form method="POST" action="{{ route('teacher.question-categories.destroy', $categoryRow) }}" data-confirm-delete>
                                            @csrf
                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end student-drawer" tabindex="-1" id="addCategoryDrawer" aria-labelledby="addCategoryDrawerLabel">
        ...
        <div class="offcanvas-body">
            @include('teacher.question-categories.partials.form', [
                'category' => $category,
                'branch' => $branch,
                'action' => route('teacher.question-categories.store'),
                'method' => 'POST',
        ...
        <div class="offcanvas offcanvas-end student-drawer" tabindex="-1" id="editCategoryDrawer{{ $categoryRow->id }}" aria-labelledby="editCategoryDrawerLabel{{ $categoryRow->id }}">
            ...
            <div class="offcanvas-body">
                @include('teacher.question-categories.partials.form', [
                    ...
                    'branch' => $branch,
                    'action' => route('teacher.question-categories.update', $categoryRow),
                    'method' => 'PUT',

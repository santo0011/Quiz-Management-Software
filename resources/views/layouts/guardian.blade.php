...
<head>
    ...
    <title>@yield('title', 'Guardian Portal') - {{ config('app.name') }}</title>
...
<body class="student-portal-body">
    <div class="admin-shell student-shell">
        @include('partials.guardian-sidebar')
        ...
        <div class="admin-main">
            <header class="admin-topbar student-panel-topbar">
                ...
                <div>
                    <span class="page-kicker">Guardian Panel</span>
                    <h1>@yield('page-title', 'Dashboard')</h1>
                </div>

                <div class="topbar-actions">
                    <div class="admin-user">
                        <div class="avatar">{{ strtoupper(substr(auth('guardian')->user()?->email ?? 'G', 0, 1)) }}</div>
                        <div class="admin-user-copy">
                            <strong>Guardian</strong>
                            <span>{{ auth('guardian')->user()?->email }}</span>
                        </div>
                    </div>
                </div>
            </header>
    ...
    <script>
        ...
        const savedSidebarState = localStorage.getItem('quizcore.guardian.sidebar.collapsed');
        ...
        sidebarToggle?.addEventListener('click', () => {
            ...
            localStorage.setItem('quizcore.guardian.sidebar.collapsed', String(collapsed));
